<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignIn.aspx.cs" Inherits="prjShoppingArena.SignIn" %>
            ...
            <div class ="form-horizontal ">
              ...
              <%--  for forgot password--%>
                 <div class ="form-group">
                    <div class ="col-md-2 "> </div>
                    <div class ="col-md-6 ">
                        <asp:HyperLink ID="HyLinkForgotPass" runat="server" NavigateUrl="ForgotPassword.aspx">Forgot Password</asp:HyperLink>
